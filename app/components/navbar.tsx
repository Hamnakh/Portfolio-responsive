            ...
            <nav className="bg-gray-900 text-white w-full h-16 flex justify-between items-center px-6 lg:px-16 py-4 lg:py-5">
                ...
                <div className="hidden lg:flex items-center gap-16">
                    ...
                    <ul className="flex text-xl font-semibold gap-10">
                        ...
                        <li className="hover:text-yellow-400 hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-yellow-400 hover:transition hover:duration-300 hover:ease-in-out "><Link href="./skills">Skills</Link></li>
                    </ul>

                    <ul className="flex text-xl font-semibold gap-10">
                        <li className="hover:text-white/75"><Link href="https://www.linkedin.com/in/hamna-khan-9b1a81259/"><FaLinkedin /></Link></li>
                        <li className="hover:text-white/75"><Link href="https://github.com/Hamnakh"><FaGithub /></Link></li>
                        <li className="hover:text-white/75"><Link href="https://www.facebook.com/hamnas.khan.12"><FaFacebook /></Link></li>
                        <li className="hover:text-white/75"><Link href="https://www.instagram.com/hamnas.khan.129/"><FaInstagram /></Link></li>
                    </ul>
                </div>
            </nav>
