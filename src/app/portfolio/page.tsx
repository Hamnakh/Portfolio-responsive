...
import Imageblog from '@/public/images/blogs.png'
import Imagefigm from '@/public/images/figm.png'
import Imagepf from '@/public/images/pf pic.png'
                ...
                <div className="project-img-box w-full px-2 lg:px-40">
                    <div className="project-img w-full h-fit my-10 px-2 lg:py-2 block lg:flex">
                        <div className="img-box-1 relative sm:mr-5 my-5 lg:my-0">
                            <Image src={Imageblog} alt="Project" width={400} height={400} className='mr-0 lg:mr-5 h-[300px] w-full lg:max-w-[600px] object-cover' />
                        ...
                        <div className="img-box-2 relative sm:mr-5">
                            <Image src={Imagefigm} alt="Project" width={400} height={400} className="mr-0 lg:mr-5 h-[300px] w-full lg:max-w-[600px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
                    ...
                    <div className="project-img w-full h-fit lg:my-10 px-2 lg:py-2 block lg:flex">
                        <div className="img-box-1 relative sm:mr-5 my-5 lg:my-0">
                            <Image src={Imagepf} alt="Project" width={400} height={400} className="mr-0 lg:mr-5 h-[300px] w-full lg:max-w-[600px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
